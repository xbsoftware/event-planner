...
function EventsPageContent() {
  ...
  useEffect(() => {
    ...
    const sessionEditId = typeof window !== 'undefined' ? sessionStorage.getItem('editEventId') : null
    ...
    if (targetEventId && !editDialogOpen) {
      ...
      console.log('Event found for editing:', eventToEdit?.label || 'NOT FOUND')
          ...
          <Card>
            <CardContent className="text-center py-12">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">
                {user?.role === 'MANAGER' ? 'No events created yet' : 'No events available'}
              </h3>
